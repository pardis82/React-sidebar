    ...
    >
      ...
      >
        ...
        <InputType
          ...
          className={clsx(
            "w-full bg-transparent outline-none text-xs leading-normal font-sans text-right ",
      ...
      {/* Error message */}
      {errorMessage ? (
        <p className="text-red-500 font-sans text-[12.5px] mt-1">
          {errorMessage}
        </p>
      ) : helperText ? (
        <p className="text-gray-500 font-sans  text-[12.5px] mt-1">
          {helperText}
        </p>
      ) : null}
    </div>
